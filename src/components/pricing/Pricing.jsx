    ...
    <div className="h-screen relative md:flex bg-linear-to-l from-orange-200 via-orange-100 to-orange-50">
      ...
      <div className="container mx-auto h-full flex flex-col justify-center items-center gap-3 p-4">
        ...
        <div className="flex flex-col gap-2 text-center items-center">
          ...
          <p className="">
            Start for free with up to 3 opportunity postings. Upgrade{" "}
            <br className="hidden xs:block" /> anytime to unlock unlimited
            opportunities, advanced <br className="hidden xs:block" />{" "}
            collaboration tools, and premium features.
          </p>
          <Button
            variant="outline"
            className="rounded-sm border-none bg-orange-500 font-bold text-white shadow-sm hover:shadow-orange-500 hover:bg-orange-700"
          >
        ...
        <div className="flex flex-col gap-2 items-center text-center">
          <h1 className="font-bold text-2xl">
            Unlock <span className="text-indigo-500">Premium</span>
          </h1>
        ...
        <div className="bg-linear-to-r from-orange-200 via-orange-100 to-orange-50 rounded-sm p-4 flex flex-col gap-3 shadow-sm hover:shadow-orange-300">
          ...
          <div className="flex flex-col items-center text-center gap-2 cursor-pointer">
            <h1 className="flex items-center font-bold text-3xl">
              <FaDollarSign />
              <span>
                49<sub className="text-gray-400">.99</sub>
              </span>
            </h1>
          ...
          <div>
            <ul className="flex flex-col gap-2">
              <li className="flex items-center gap-1">
                <IoIosCheckmark size={20} className="text-green-500" />
          ...
          <form action="/api/subscription" method="POST">
            <section>
              <Button
                type="submit"
                role="link"
                className="border-none rounded-sm text-xs w-full bg-orange-500 shadow-sm hover:shadow-orange-500 hover:bg-orange-700"
              >
                <BsLightningCharge />
